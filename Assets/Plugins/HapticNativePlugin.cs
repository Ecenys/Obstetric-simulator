...
public class HapticNativePlugin
{
    ...
    [DllImport("UnityPlugin")]
    public static extern bool moveTo(double px, double py, double pz, bool block);
    ...
    [DllImport("UnityPlugin")]
    protected static extern void addSimpleObject(double[] objectPos, double[] objectScale, double[] objectRotation, double[,] vertPos, double[,] normals, int vertNum, int[,] tris, int triNum, double siffness, double estatica, double dinamica);
    ...
    public static int AddSimpleObject(Vector3 position, Vector3 scale, Vector3 rotation, Vector3[] vertPos, Vector3[] normals, int vertNum, int[,] tris, int triNum, double siffness, double estatica, double dinamica)
    {
        double[] objectPosition = new double[3];
        objectPosition[0] = (double)position.x;
        objectPosition[1] = (double)position.y;
        ...
        addSimpleObject(objectPosition, objectScale, objectRotation, objectVertPos, objectNormals, vertNum, tris, triNum, siffness, estatica, dinamica);
